...
public class Week7SpringSecurityAppApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(Week7SpringSecurityAppApplication.class, args);
	}

	private BookService bookService;

	@Autowired
	Week7SpringSecurityAppApplication(BookService bookService){
