...
public class DishMVCController {
    ...
    public String postBook(@ModelAttribute Book book,Model model){
        ...
        if(saveCode==0){
            model.addAttribute("msg","Year too big or entered full year. failed to add!");
            return "catalogue";
        }
        model.addAttribute("msg","successfully added item");
        return "catalogue";
    }
    ...
    @GetMapping("/delete/{id}")
        ...
        if (deleteStatusCode==1) {
            ...
            return "redirect:/library/catalogue/1?msg=Item Deleted successfully";

        }
        //model.addAttribute("books",bookService.getAllBooks());
        //model.addAttribute("msg", "book doesn't exist. Delete failed");
        return "redirect:/library/catalogue/1?msg=Failed to delete. Item doesn't exist";
    }
    ...
    public String updateBook(@ModelAttribute Book book) {
        ...
        return "redirect:/library/catalogue/1?msg=Item Updated Successfully";
    }
}
